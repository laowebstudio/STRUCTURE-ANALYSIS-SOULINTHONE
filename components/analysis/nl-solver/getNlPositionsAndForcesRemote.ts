...
const NL_SOLVE_ENDPOINT = import.meta.env.VITE_SAPUDOM_NL_SOLVE_ENDPOINT as string | undefined;
...
export async function getNlPositionsAndForcesRemote(
  ...
  if (!NL_SOLVE_ENDPOINT) {
    throw new Error(
      "SAPUDOM nonlinear solver backend is not configured. Set VITE_SAPUDOM_NL_SOLVE_ENDPOINT after deploying your own compatible nonlinear solver service.",
    );
  }
